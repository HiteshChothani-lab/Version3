...
namespace UserManagement.Common.Constants
{
    ...
    public static class Config
    {
        ...
        private const string Version3 = "Version3-";
        public static readonly string AppVersionName = "Version 3";
        ...
        public static string FilePath = Path.Combine(AppPath, Version3);
